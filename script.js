const expirationSelect = document.querySelector("[data_expiration_year]")
const logo = document.querySelector("[data_logo]")
...
document.addEventListener("keydown" , e =>{
    ...
    const key = e.key;
    if(!isConnedtedInput(input)) return
...
function isConnedtedInput(input){
    const parent = input.closest("[data_connected_inputs]")
